            ...
            override fun onIncomingCallReceived(call: Call) {
                if (CometChat.getActiveCall() == null) {
                    if (call.receiverType == CometChatConstants.RECEIVER_TYPE_USER) {
                        CometChatUtils.startCallIntent(context!!, call.callInitiator as User, call.type,
                                false, call.sessionId)
                    } else {
                        CometChatUtils.startGroupCallIntent(context!!, call.receiver as Group, call.type,
                                false, call.sessionId)
                    }
                } else {
